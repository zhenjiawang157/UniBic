...
"===================================================================\n\
[Usage]\n\
$ ./unibic -i filename [argument list]\n\
===================================================================\n\
[Input]\n\
...
-q : use quantile discretization for continuous data\n\
     default: 0.5 or 15/#col (see details in Method section in paper)\n\
...
static void init_options ()
{
	...
	po->dataMode = 0;	/*0 Preprocessing by value as Q; 1 Preprocessing by number*/
}
...
void get_options (int argc, char* argv[])
{
	 ...
	 */
	while ((op = getopt(argc, argv, "i:b:q:r:dsf:k:o:c:T:PSCMu:l:h")) >0)
	{
		switch (op)
		{
